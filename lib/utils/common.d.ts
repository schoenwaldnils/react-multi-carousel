...
declare function getTransformForCenterMode(state: CarouselInternalState, props: CarouselProps, transformPlaceHolder?: number, partialVisibilityGutter?: number): number;
